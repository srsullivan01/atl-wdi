...
8.  If I modify a class in Ruby by adding a method, will instances of that class
  ...
  ```text
  No, because the changes can only be applied going forward and not retroactively. 
  ```
